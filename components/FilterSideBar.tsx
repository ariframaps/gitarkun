          ...
          <ul className="space-y-2 font-medium">
            <li className="ms-3 flex flex-col gap-10">
              ...
              <button
                ...
                className=" bg-yellow-400 w-max px-4 text-black hover:bg-yellow-600 text-center flex items-center focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 md:py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Clear
              </button>
            </li>
          </ul>
