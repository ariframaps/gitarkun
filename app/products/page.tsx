          ...
          <div className="flex-1 flex flex-col gap-10 items-center">
            <form
              ...
              <div className="relative">
                ...
                <button
                  type="submit"
                  className="rounded-md border-none absolute end-2.5 bottom-2.5 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800  bg-yellow-400 border border-black hover:bg-yellow-500 text-black">
                  Search
                </button>
              </div>
            </form>
